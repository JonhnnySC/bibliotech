 ...
 *  1. O @Transactional do Spring só faz ROLLBACK, por padrão, em exceções não verificadas.
 *     Com uma exceção "checked", a transação seria confirmada mesmo com erro.
 *  2. Não obriga todo método acima a declarar "throws".
 */
